                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="project_type" id="project_type" class="form-control required">
                                    ...
                                    <option value="{{$cKey}}" {{isset($data['project_type']) && $data['project_type'] ==$cKey?'selected':''}}>{{$cVal}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                @if (isset($data['photo']))
                                    <div class="col-md-6 mt-2">
                                        <a href="{{ asset('uploads/projects/' . $data['photo']) }}"
                        ...
                        <div class="mt-2">
                            ...
                            {!! Helper::getFormCancelButton(route('frontend_projects.index')) !!}
                        </div>
                    </div>
                </div>
                <!-- /Account -->
