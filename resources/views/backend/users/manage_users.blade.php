                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ !empty($data['profile_img']) ? asset('users/' . $data['profile_img']) : asset('assets/img/avatars/2.jpg') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control required digits" id="zipcode" name="zipcode"
                                    value="{{ $data['zipcode'] ?? old('zipcode') }}" placeholder="231465"
                                    maxlength="10" />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="password"
                                    class="form-control {{ !isset($data['password']) ? 'required' : '' }} password"
                                    id="password" name="password" value="{{ old('password') }}"
                                    placeholder="example@123" minlength="6" />
                            </div>
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="password"
                                    ...
                                    value="{{ old('password_confirmation') }}" placeholder="example@123"
                                    minlength="6" />
                            </div>
                        </div>
                        <div class="mt-2">
                            {!! Helper::getFormSubmitButton() !!}
                            {!! Helper::getFormCancelButton(route('users.index')) !!}
                        </div>
                    </div>
                    <!-- /Account -->
                </div>
