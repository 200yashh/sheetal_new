        ...
        <div class="container py-5 px-lg-5">
            <div class="owl-carousel testimonial-carousel">
                @if (!empty($testimonialData)) 
                    @foreach ($testimonialData as $tKey => $tVal)
                    <div class="testimonial-item bg-transparent border rounded text-white p-4">
                        <i class="fa fa-quote-left fa-2x mb-3"></i>
                        <p>{{$tVal['description']??''}}</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle"
                                src="{{ !empty($tVal['image_path']) ? asset($tVal['image_path']): asset('frontend/img/testimonial-1.jpg') }}" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h6 class="text-white mb-1">{{$tVal['name']??''}}</h6>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="d-flex">
                            ...
                            <img class="img-fluid rounded w-100" src="{{ asset('frontend/img/team-1.jpg') }}"
                                alt="">
                        </div>
                        <div class="px-4 py-3">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="d-flex">
                            ...
                            <img class="img-fluid rounded w-100" src="{{ asset('frontend/img/team-2.jpg') }}"
                                alt="">
                        </div>
                        <div class="px-4 py-3">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="d-flex">
                            ...
                            <img class="img-fluid rounded w-100" src="{{ asset('frontend/img/team-3.jpg') }}"
                                alt="">
                        </div>
                        <div class="px-4 py-3">
